...
def validate_hostile():
    ...
    req(actions["mode"]=="BOUNDED_CHANNEL_EXECUTION" and set(actions["allowed_actions"])=={"CUSTOMER_EMAIL"},"action executor widened beyond approved channel")
    ...
    req("DUPLICATE_SUPPRESSED" in executor and "RECIPIENT_DAILY_LIMIT" in executor and "PORTFOLIO_ACTIONS_DISABLED" in executor,"action idempotency/rate/kill-switch defense missing")
