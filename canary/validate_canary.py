...
def validate_canary(output_dir=None):
    ...
    try:
        ...
        req(first["scheduler_blocked_approval_count"]==0,"resolved education approval work remains blocked")
        ...
        req(cont["notifications_emitted"]==0 and cont["notification_suppressed"]>=1,"notification continuation was not suppressed")
