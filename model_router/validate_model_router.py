...
def validate_model_router():
    ...
    req(gw["source_revision"]=="dcca6215f2439bb55391335fe0513f471c762290","runtime gateway pin revision mismatch")
    req(gw["gateway"]["blob_sha"]=="fdc77391ce6ed3e0f6db25aed859aa684e0818f0","runtime gateway blob mismatch")
    state=load("PORTFOLIO_BUILD_STATE.json");req(state["repositories"]["REPO-001"]["last_inspected_sha"]=="dcca6215f2439bb55391335fe0513f471c762290","source cursor not reconciled")
